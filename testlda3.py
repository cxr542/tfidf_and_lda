...
StopWords = set(stopwords.words("english"))
    # add custom words
StopWords.update(('and', 'may', 'a', 'use', 'us','so', 'your', 'this','x','v','w','in','p','when', 'it', 'many', 'can', 'set', 'cant',
...
print ("{} (top topic:{})".format(docs[0],doc_topic[0].argmax()))
print ("{} (top topic:{})".format(docs[1],doc_topic[1].argmax()))
print ("{} (top topic:{})".format(docs[3032],doc_topic[3032].argmax()))
print ("{} (top topic:{})".format(docs[3035],doc_topic[3035].argmax()))
